                ...
                <?php foreach ($clients as $client): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?id=<?= htmlspecialchars($client['id_client']) ?>&action=modifier" class="btn btn-warning">Modifier</a>
                            <a href="index.php?id=<?= htmlspecialchars($client['id_client']) ?>&action=supprimer" class="btn btn-danger"
